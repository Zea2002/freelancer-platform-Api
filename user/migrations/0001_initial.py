...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile_pic', models.ImageField(blank=True, null=True, upload_to='user/media/freelancer/')),
                ...
                ('skills', models.ManyToManyField(related_name='freelancers', to='user.skill')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='freelancer_profile', to='user.user')),
            ],
        ),
        migrations.CreateModel(
            name='ClientProfile',
            fields=[
                ...
                ('phone', models.CharField(max_length=12)),
                ('profile_pic', models.ImageField(blank=True, null=True, upload_to='user/media/client/')),
